...
return [
    ...
    'fake_pix_base_url' => env('FAKE_PIX_BASE_URL', 'http://host.docker.internal:8080'),
    'fake_pix_api_key' => env('FAKE_PIX_API_KEY', 'fake-pix-demo'),
    'fake_pix_callback_url' => env('FAKE_PIX_CALLBACK_URL', 'http://localhost/v1/webhooks/payment'),
];
